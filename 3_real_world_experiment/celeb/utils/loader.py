...
def stack_data(train_val_split, split_type, case_id):
    ...
    if case_id == "athlete_1m":
        ...
        X_flat = [train_val_split[f"X11_{split_type}"], train_val_split[f"X12_{split_type}"], train_val_split[f"X13_{split_type}"], train_val_split[f"X21_{split_type}"], train_val_split[f"X22_{split_type}"], train_val_split[f"X23_{split_type}"]]
