...
from scenario import athlete_1m, athlete_3m
...
def parse_args():
    ...
    parser.add_argument('--case_id', type=str, default='athlete_3m')
    ...
    parser.add_argument('--eta_dims', type=int, nargs='+', default=[1, 1, 1, 1, 1, 1])
    parser.add_argument('--latent_dims', type=int, nargs='+', default=[10, 10, 10, 5, 5, 5])
    parser.add_argument('--input_types', type=str, nargs='+', default=['mnist', 'mnist', 'mnist', 'mnist', 'mnist', 'mnist'])
    parser.add_argument('--input_order', type=str, nargs='+', default=['mnist', 'mnist', 'mnist', 'mnist', 'mnist', 'mnist'])
    parser.add_argument('--hidden_dims', type=int, nargs='+', default=[16, 16, 16, 16, 16, 16])
    parser.add_argument('--shared_dims', type=int, nargs='+', default=[1, 1, 1, 1, 1, 1])
    
    # Training Parameters
    parser.add_argument('--seed', type=int, default=random.randint(0, 2**32 - 1))
    parser.add_argument('--seed', type=int, default=3211822)
    parser.add_argument('--lr', type=float, default=3e-4)
    parser.add_argument('--recon_coef', type=float, default=1)
    parser.add_argument('--kl_coef', type=float, default=1e-2)
    parser.add_argument('--sparsity_coef', type=float, default=1e-3)

    parser.add_argument('--num_epochs', type=int, default=int(1000)) 
...
def main():
    args = parse_args()
    # args.seed = 2019307291 
    seed_everything(args.seed)
    
    DATA_SCENARIOS = {
        "athlete_3m": lambda: athlete_3m(args) 
    }
