...
This is the official implementation of the paper **"[PersonaX: Multimodal Datasets with LLM-Inferred Behavior Traits](https://openreview.net/pdf?id=x446ASYlCt)"**, ICLR 2026. ([Project](https://minghaofu.github.io/webpages/PersonaX/index.html))
